            ...
            <div class="flex items-center gap-4 text-xs text-gray-500">
                ...
                <div class="flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M15.5 7.5a.5.5 0 01.444.89l-1.444.89a.5.5 0 01-.444-.89l1.444-.89zM16.444 8.39a.5.5 0 010 .89l-1.444.89a.5.5 0 01-.444-.89l1.444-.89zM16 12a1 1 0 01-1 1H2a1 1 0 01-1-1V6a1 1 0 011-1h1.172a3 3 0 002.12-.879l.88-.879A1 1 0 017 3h6a1 1 0 01.707.293l.879.879A3 3 0 0016.707 5H18a1 1 0 011 1v6a1 1 0 01-1 1h-2zM4 8a2 2 0 100 4 2 2 0 000-4z" />
                    </svg>
...
<div class="flex-shrink-0 flex items-center justify-end gap-1 p-2 bg-gray-50 border-t border-gray-100">
            ...
            <button data-action="play" title="Abspielen" class="p-2 rounded-full text-gray-600 hover:bg-gray-200 transition-colors">
            ...
            <button data-action="edit-info" title="Infos bearbeiten" class="p-2 rounded-full text-gray-600 hover:bg-gray-200 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M13.586 3.586a2 2 0 112.828 2.828l-1.172 1.172-2.828-2.828 1.172-1.172zM11.172 6.172L2.5 14.844V17.5h2.656l8.672-8.672-2.656-2.656z" />
                </svg>
            </button>
    ...
    `;
        ...
        card.querySelector('[data-action="play"]').addEventListener('click', () => openPlayback(project.media));
